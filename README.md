...
So you might think, so what? Just some imports change. But this is only one part of the story. Yes, the imports changed, and as you can see later in the example, you can basically leave youare existing Keras code intact most of the times and just change the import and you are done.
